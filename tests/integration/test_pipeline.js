...
async function runPipeline() {
    const pdfPath = path.join(__dirname, '../../public/samples/Vita_e_avventure_di_Robinson_Crusoè.pdf');
    ...
    try {
        ...
        const result = await extractTextFromPDF(mockFile, 10);
        ...
        const outputPath = path.join(__dirname, '../outputs/pipeline_output.json');
